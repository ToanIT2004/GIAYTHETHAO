      ...
      <div class="col-lg-8 offset-md-2">
         <div class="card">
            <div class="card-header">
               <h4 class="text-secondary">Thay đổi mật khẩu</h4>
            </div>
            <div class="card-body">
               <form id="form_change_password">
                  ...
                  <div class="mb-3">
                     ...
                     <input name="password_old" id="password_old" type="password" class="form-control" placeholder="Nhập mật khẩu">
                     <small id="password_old_error" class="text-danger badge"></small>
                  </div>
                  <div class="mb-3">
                     <label class="form-label fw-bolder fs-6">Mật khẩu mới</label>
                     <input name="password_new" id="password_new" type="password" class="form-control" placeholder="Nhập mật khẩu">
                     <small id="password_new_error" class="text-danger badge"></small>
                  </div>
                  <div class="mb-3">
                     <label class="form-label fw-bolder fs-6">Nhập lại khẩu mới</label>
                     <input name="confirm_password_new" id="confirm_password_new" type="password" class="form-control" placeholder="Nhập mật khẩu" >
