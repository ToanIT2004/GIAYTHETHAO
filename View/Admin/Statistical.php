...
<div class="container mt-5">
   <div class="row">
      <div class="col-lg-4">
         <div class="bg-info shadow-lg p-3 mb-5 bg-body-tertiary rounded d-flex justify-content-around">
            <i class="bi bi-cash-coin fs-1 mt-4"></i>
            <div>
               <h3>Tổng tiền</h3>
               <b class="fs-3">
                  <?php 
                     $statistical = new Statistical();
                     $total_money = $statistical->total_Money();
      ...
      <div class="col-lg-4">
      <div class="bg-warning shadow-lg p-3 mb-5 bg-body-tertiary rounded d-flex justify-content-around">
            <i class="bi bi-cart-check fs-1 mt-4"></i>
            <div>
               <h3>Đơn hàng</h3>
      ...
      <div class="col-lg-4">
      <div class="bg-success shadow-lg p-3 mb-5 bg-body-tertiary rounded d-flex justify-content-around">
   ...
   <div class="row">
      <div class="col-lg-6">
         <h3>THỐNG KÊ BIỂU ĐỒ NGÀY</h3>
         <canvas height="200" id="myLineChart"></canvas>
      </div>
      <div class="col-lg-6">
         <h3>THỐNG KÊ ĐƠN HÀNG THÁNG</h3>
   ...
   <div class="row mt-5">
      <div class="col-lg-7">
         <h3>TOP 3 SẢN PHẨM BÁN NHIỀU NHẤT</h3>
